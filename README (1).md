...
![datasetdf](https://github.com/abhisekpattanaik/melonama/blob/main/Datasetdf.png)

![datasetplot](https://github.com/abhisekpattanaik/melonama/blob/main/DatasetPlot.png)

To overcome the issue of class imbalance, used a python package  Augmentor (https://augmentor.readthedocs.io/en/master/) to add more samples across all classes so that none of the classes have very few samples.

### Sample image from Dataset

![sample image](https://github.com/abhisekpattanaik/melonama/blob/main/Samleimagefromdataset.png)
...
### Model Architecture
![Model Arch](https://github.com/abhisekpattanaik/melonama/blob/main/ModelLayer.png)

### Model Evaluation
![ModelEvaluation](https://github.com/abhisekpattanaik/melonama/blob/main/ModelEvaluation.png)
